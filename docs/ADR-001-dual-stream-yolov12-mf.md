...
**用途**：精确隔离 Step 3（DMGFusion v2 vs v1）的贡献；验证 Step 1+2 自身带来多少提升

#### 最终对照矩阵

| 实验 | P4 | P2 fusion | aux head | 主要验收目标 |
|------|----|-----------|---------|------------|
| Exp-7a（基线） | A2C2f | DMGFusion v1 | 无 | 参照 0.628 |
| **Exp-8a** | **C3k2** | DMGFusion v1 | **有** | P4条带消除 + RGB特征恢复 |
| **Exp-8b** | C3k2 | **DMGFusion v2** | 有 | P2 fused干净 + fire↑ |
| Exp-8c | C3k2 | DMGFusion v1 | 有 | 归因 Step3 独立贡献 |
