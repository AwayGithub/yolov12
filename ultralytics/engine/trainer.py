...
class BaseTrainer:
    ...
    def _do_train(self, world_size=1):
        ...
        val_period = max(int(getattr(self.args, "val_period", 1)), 1)
        ...
        while True:
            ...
            gc.collect()  # 每 epoch 归还 Python 碎片内存，防止 RAM 单调增长
    ...
    def optimizer_step(self):
        ...
        torch.nn.utils.clip_grad_norm_(self.model.parameters(), max_norm=1.0)  # clip gradients (reduced from 10.0 to suppress m_self explosion in CMA models)
